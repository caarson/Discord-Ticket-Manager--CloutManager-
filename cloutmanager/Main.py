...
# variables
########################################################################
token = "NjA3NzE1OTA5NTMxODYwOTky.XxjDyg.mkH7MkBVn-tycTPgIJig8B0GBMA"  # Get at discordapp.com/developers/applications/me | switch to change server location.
...
# create the ticket and print messages into chat, then intitiate the walk through:
@bot.event
async def on_message(message):
    if message.guild:
        ...
        if role.mention in message.content:  # if role is inside of the message.content, perform actions.
            ...
            await channel.send("Welcome to Clout Studios! \nTo get a list of options for your next video, just type: \n>list_options \n A Clout Sales representive will be with you shortly!")
